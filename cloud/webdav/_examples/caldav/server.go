...
import (
	...
	"github.com/unix-world/smartgoext/cloud/webdav/caldav"
)

func main() {
    fmt.Println("See code examples in this file source code ...")
}
...
func (t testBackend) PutCalendarObject(ctx context.Context, path string, calendar *ical.Calendar, opts *caldav.PutCalendarObjectOptions) (string, error) {
	return "", nil
}
...
func (t testBackend) QueryCalendarObjects(ctx context.Context, query *caldav.CalendarQuery) ([]caldav.CalendarObject, error) {
	return nil, nil
}
