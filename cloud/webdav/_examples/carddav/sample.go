...
import (
	...
	"github.com/unix-world/smartgoext/cloud/webdav"
	"github.com/unix-world/smartgoext/cloud/webdav/carddav"
)

func main() {
    fmt.Println("see the code examples in the source code of this file ...")
}
...
func (*testBackend) AddressBook(ctx context.Context) (*carddav.AddressBook, error) {
...
func (b *testBackend) ListAddressObjects(ctx context.Context, req *carddav.AddressDataRequest) ([]carddav.AddressObject, error) {
...
func (*testBackend) QueryAddressObjects(ctx context.Context, query *carddav.AddressBookQuery) ([]carddav.AddressObject, error) {
	panic("TODO: implement")
}

func (*testBackend) PutAddressObject(ctx context.Context, path string, card vcard.Card, opts *carddav.PutAddressObjectOptions) (loc string, err error) {
	panic("TODO: implement")
}
