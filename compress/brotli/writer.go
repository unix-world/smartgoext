...
// modified by unixman: add Mode in options
...
//	"github.com/andybalholm/brotli/matchfinder"
	"github.com/unix-world/smartgoext/compress/brotli/matchfinder"
)
...
func (w *Writer) Reset(dst io.Writer) {
	encoderInitState(w)
	w.params.mode = w.options.Mode // improvement by unixman
