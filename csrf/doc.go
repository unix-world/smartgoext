...
in order to protect malicious POST requests being made:
	...
	import (
		...
		"github.com/unix-world/smartgoext/csrf"
		"github.com/unix-world/smartgoext/mux"
	)
...
(https://github.com/unix-world/smartgoext/securecookie) library. They're also Secure (issued
