...
import (
	...
	"github.com/unix-world/smartgoext/db/mongo-driver/internal/aws/credentials"
	"github.com/unix-world/smartgoext/db/mongo-driver/internal/credproviders"
	"github.com/unix-world/smartgoext/db/mongo-driver/x/mongo/driver"
	"github.com/unix-world/smartgoext/db/mongo-driver/x/mongo/driver/auth/creds"
)
