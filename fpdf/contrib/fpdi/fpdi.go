/*
Package fpdi wraps the fpdi PDF library to import existing PDFs as templates. See github.com/unix-world/smartgoext/fpdi
...
import (
	...
	gofpdi "github.com/unix-world/smartgoext/fpdi"
)
