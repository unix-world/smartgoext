...
import (
	...
	textm "github.com/unix-world/smartgoext/markup/goldmark/text"
...
type Node interface {
	...
	// SetAttributes will set attributes to a node
	SetAttributes(atts []Attribute) // unixman
}
...
//-- unixman
func (n *BaseNode) SetAttributes(atts []Attribute) {
	n.attributes = atts
}
//-- #
