...
func TestCompileFail() {
	...
	check("(",       "PCRE2 compilation failed at offset 1: missing closing parenthesis")
	check(`\`,       `PCRE2 compilation failed at offset 1: \ at end of pattern`)
	check(`abc\`,    `PCRE2 compilation failed at offset 4: \ at end of pattern`)
	check("abc\000", "PCRE2 compilation failed at offset 3: NUL byte in pattern")
	check("a\000bc", "PCRE2 compilation failed at offset 1: NUL byte in pattern")
