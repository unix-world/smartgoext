...
// Put form xobjects and get back a map of template names (e.g. /FPDITPL1) and their object ids (int)
...
// Put form xobjects and get back a map of template names (e.g. /FPDITPL1) and their object ids (sha1 hash)
...
// For a given template id (returned from ImportPage), get the template name (e.g. /FPDITPL1) and
