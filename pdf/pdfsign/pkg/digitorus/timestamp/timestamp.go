...
func (opts *RequestOptions) hash() crypto.Hash {
	...
	//	return crypto.SHA256
		return crypto.SHA384 // {{{SYNC-PDFSIGN-DEFAULT-HASH-ALGO}}}
	}
	return opts.Hash
}
...
// certificate itself is provided alongside the timestamp response signature.
//
// This function is equivalent to CreateResponseWithOpts, using a SHA384 hash.
//
...
//	return t.CreateResponseWithOpts(signingCert, priv, crypto.SHA256)
	return t.CreateResponseWithOpts(signingCert, priv, crypto.SHA384)
}
...
func (t *Timestamp) populateSigningCertificateV2Ext(certificate *x509.Certificate) ([]byte, error) {
	...
	// HashAlgorithm defaults to SHA384
//	if t.HashAlgorithm.HashFunc() != crypto.SHA256 {
	if t.HashAlgorithm.HashFunc() != crypto.SHA384 {
